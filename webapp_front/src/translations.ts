...
export const translations = {
  en: {
    ...
    profile: {
      ...
      avatarSelect: "Avatar (emoji allowed)",
      uploading: "Processing...",
      uploadPhoto: "Upload photo (compressed)",
      orTypeEmoji: "Or type emoji manually",
      name: "Name",
      save: "Save",
      saving: "Saving...",
      cancel: "Cancel",
    ...
    friends: {
      ...
      enterCode: "Enter friend's code (e.g. A3F9C2)",
      add: "Add",
      requests: "Requests",
      accept: "Accept",
      noFriends: "No friends yet",
      addByCodeHint: "Add a friend using the code above"
    },
    settings: {
      title: "Settings",
  ...
  ru: {
    ...
    profile: {
      ...
      avatarSelect: "Аватар (можно эмодзи)",
      uploading: "Обработка...",
      uploadPhoto: "Загрузить фото (сжимается)",
      orTypeEmoji: "Или введите свой эмодзи вручную",
      name: "Имя",
      save: "Сохранить",
      saving: "Сохранение...",
      cancel: "Отмена",
      ...
      retention: "Удержание",
      promoCode: "Промокод",
      gameReward: "Награда за игру",
      noTransactions: "Нет транзакций",
      yourCode: "КОД:"
    },
    friends: {
      myCode: "Ваш код для друзей:",
      clickToCopy: "нажмите чтобы скопировать",
      addFriend: "Добавить друга",
      enterCode: "Введите код друга (например: A3F9C2)",
      add: "Добавить",
      requests: "Заявки",
      accept: "Принять",
      noFriends: "Нет друзей",
      addByCodeHint: "Добавьте друга по коду выше"
    },
    settings: {
      title: "Настройки",
  ...
  uz: {
    ...
    venueDashboard: {
      ...
      dailyActive: "Bugungi sessiyalar",
      ...
      pointsAwarded: "Berilgan ballar",
      redeemedPrizes: "Berildi",
      hoursLabel: "s",
      minutesLabel: "d",
      noData: "Faollik yo'q",
    ...
    profile: {
      ...
      account: "Hisob",
      prizesShop: "Mening yutuqlarim",
      leaderboards: "Liderlar jadvali",
      editProfile: "Profilni tahrirlash",
      avatarSelect: "Avatar (emoji ham mumkin)",
      uploading: "Qayta ishlanmoqda...",
      uploadPhoto: "Rasm yuklash",
      orTypeEmoji: "Yoki o'z emojingizni kiriting",
      name: "Ism",
      save: "Saqlash",
      saving: "Saqlanmoqda...",
      cancel: "Bekor qilish",
      bestScore: "Eng yaxshi natija",
      transactionHistory: "Tranzaksiyalar",
      users: "Foydalanuvchilar",
      retention: "Qolish darajasi",
      promoCode: "Promokod",
      gameReward: "O'yin yutug'i",
      noTransactions: "Hali tranzaksiyalar yo'q",
      yourCode: "KOD:"
    },
    friends: {
      myCode: "Sizning do'stlik kodingiz:",
      clickToCopy: "nusxalash uchun bosing",
      addFriend: "Do'st qo'shish",
      enterCode: "Do'stingiz kodini kiriting (masalan: A3F9C2)",
      add: "Qo'shish",
      requests: "So'rovlar",
      accept: "Qabul qilish",
      noFriends: "Hali do'stlar yo'q",
      addByCodeHint: "Yuqoridagi kod yordamida do'st qo'shing"
    },
    settings: {
      title: "Sozlamalar",
